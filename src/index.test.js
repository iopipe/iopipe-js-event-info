...
describe('understanding of S3 event records', () => {
  it('creates awsRegion custom metric', () => {
    ...
    expect(invocationInstance.logData['event-s3-awsRegion']).toEqual(
      sampleS3record.Records[0].awsRegion
    );
  });
});
...
describe('understanding of kinesis event records', () => {
  it('creates awsRegion custom metric', () => {
    ...
    expect(invocationInstance.logData['event-kinesis-awsRegion']).toEqual(
      sampleKinesisRecord.Records[0].awsRegion
    );
  });
});
...
describe('understanding of firehose event records', () => {
  it('creates awsRegion custom metric', () => {
    ...
    expect(invocationInstance.logData['event-kinesis-awsRegion']).toEqual(
      sampleFirehoseRecord.records[0].region
    );
  });
});
...
describe('understanding of scheduled event records', () => {
  it('creates awsRegion custom metric', () => {
    ...
    expect(
      invocationInstance.logData['event-scheduledevent-awsRegion']
    ).toEqual(sampleScheduledEventRecord.region);
  });
});
...
describe('understanding of cloudfront event records', () => {
  it('creates distributionId custom metric', () => {
    ...
    expect(
      invocationInstance.logData['event-cloudfront-distributionId']
    ).toEqual(sampleCloudfrontRecord.Records[0].cf.config.distributionId);
  });
});
...
describe('understanding of apigw event records', () => {
  it('creates accountId custom metric', () => {
    ...
    expect(invocationInstance.logData['event-apigw-accountId']).toEqual(
      sampleApiGwRecord.requestContext.accountId
    );
  });
});
describe('understanding of sns event records', () => {
  it('creates EventSubscriptionArn custom metric', () => {
    ...
    expect(
      invocationInstance.logData['event-sns-EventSubscriptionArn']
    ).toEqual(sampleSnsRecord.EventSubscriptionArn);
  });
});
